...
<div class="card mb-2">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
        <div class="card-body">
        Devastating earthquake, 2015, the school toilets were destroyed along with the schools buildings.  So, with the support of the Pragya Solutions, gender friendly School toilets were constructed in 4 different schools namely, Bhumekali School, Keureni Basic School, Belbhanjyang Basic School and Panchakanya Basic School.
        </div>
    </div>
    </div>
<div class="card mb-2">
